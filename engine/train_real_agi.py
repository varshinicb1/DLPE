...
MODEL_PATH = "engine/models/kissan_gpt_nano.pt"
DATA_DIR = "engine/data"
TOKENIZER_PATH = "engine/models/kissan_tokenizer/tokenizer.json"
OUTPUT_PATH = "engine/models/agi_core_real.pt"
...
def train():
    ...
    model = AgiCoreModel(vocab_size=155) 
